...
public class com_example_realmassignment_StudentRealmProxy extends com.example.realmassignment.Student
        ...
        if (obj == null) {
            if (json.has("id")) {
                if (json.isNull("id")) {
                    ...
                    obj = (io.realm.com_example_realmassignment_StudentRealmProxy) realm.createObjectInternal(com.example.realmassignment.Student.class, json.getLong("id"), true, excludeFields);
                }
            } else {
    ...
    public static long insert(Realm realm, com.example.realmassignment.Student object, Map<RealmModel,Long> cache) {
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.rollNoIndex, rowIndex, ((com_example_realmassignment_StudentRealmProxyInterface) object).realmGet$rollNo(), false);
